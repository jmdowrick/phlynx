...
Circulatory Autogen Model Builder (CAMB) has been designed to as a companion application for `Circulatory Autogen <https://github.com/FinbarArgus/circulatory_autogen/tree/master>`_, a software package for coupling CellML modules and facilitating model calibration, parameter identifiability, and sensitivity analysis.
